...
using Service.WalletApi.EducationHealthApi.Controllers.Contracts;
using Service.WalletApi.EducationHealthApi.Mappers;
using Service.Web;

namespace Service.WalletApi.EducationHealthApi.Controllers
{
	[Route("/api/v1/education/health")]
	public class EducationController : BaseController
	{
		private readonly IGrpcServiceProxy<ITutorialHealthService> _tutorialService;

		public EducationController(IGrpcServiceProxy<ITutorialHealthService> tutorialService,

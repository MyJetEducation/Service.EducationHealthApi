...
using Service.EducationHealthApi.Modules;
using Service.Web;
using SimpleTrading.ServiceStatusReporterConnector;

namespace Service.EducationHealthApi
{
	public class Startup
	{
		private const string DocumentName = "education/health";
		private const string ApiName = "EducationHealthApi";

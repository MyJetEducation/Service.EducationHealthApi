...
using Service.WalletApi.EducationHealthApi.Modules;

namespace Service.WalletApi.EducationHealthApi
{
	public class Startup
	{
		...
		{
			StartupUtils.SetupWalletApplication(app, env, Program.Settings.EnableApiTrace, "education/health");
